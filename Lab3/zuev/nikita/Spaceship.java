...
class Spaceship implements EngineeringTransportInterface, DrivingTransportInterface {
    ...
    public Spaceship(String name, double maxSpeed) {
        ...
        serviceableDevices.put(Device.ENGINE, true);
        serviceableDevices.put(Device.HATCH, true);
        serviceableDevices.put(Device.PORTHOLE, true);
        serviceableDevices.put(Device.STEERINGWHEEL, true);

        activatedDevices.put(Device.ENGINE, false);
        activatedDevices.put(Device.HATCH, false);
        activatedDevices.put(Device.PORTHOLE, false);
        activatedDevices.put(Device.STEERINGWHEEL, true);
    ...
    public void setActivatedDeviceStatus(Device device, Boolean status) {
        ...
        if (device == Device.ENGINE && status) {
